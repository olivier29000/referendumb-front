                  ...
                  <form autocomplete="off">
                    ...
                    <div class="d-flex">
                      <a
                        ...
                        (click)="demanderOubliMotDePasse()"
                        >{{ "login.password-forgot" | translate }}</a
                      >
                    </div>
                    <div class="d-flex justify-content-center">
                      <a
                        ...
                        class="btn btn-dashed btn-pill color-2 me-sm-3 me-2"
                      ...
                      <button
                        ...
                        type="button"
                        class="btn btn-gradient btn-pill color-2  my-2"
                      >
...
export class LoginComponent implements OnInit {
  ...
  demanderOubliMotDePasse(): void {
    this.modalOubliMotDePasse();
  }

  async modalOubliMotDePasse(): Promise<void> {
    ...
    if (email) {
      this.serverService.oubliMotDePasse(email);
    }
  }
